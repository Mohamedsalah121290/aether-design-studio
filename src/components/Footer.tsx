...
const Footer = () => {
  ...
  return <footer id="about" className="relative border-t border-border">
      {/* Background */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <motion.a href="/" className="flex items-center gap-3 mb-6 group" whileHover={{
            scale: 1.02
          }}>
              {/* Logo with Neon Glow */}
            ...
            <div className="flex gap-4">
              ...
              return <motion.a key={social.label} href={social.href} whileHover={{
                scale: 1.1,
                y: -2
              }} className="w-10 h-10 rounded-xl glass flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-primary/30 transition-colors" aria-label={social.label}>
