      ...
      <nav className="container mx-auto px-4 flex items-center justify-between">
        ...
        scale: 1.02
          ...
          <div className="relative">
            ...
            <img alt="AI DEALS" src="/lovable-uploads/4645b42b-e413-4263-b006-f7e6571b50fc.png" className="h-20 w-auto relative z-10 drop-shadow-[0_0_20px_rgba(168,85,247,0.5)] transition-all duration-300 group-hover:drop-shadow-[0_0_35px_rgba(168,85,247,0.7)] rounded-md shadow-md border-0 border-[#f7597c] border-none" />
          </div>
