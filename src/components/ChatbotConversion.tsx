...
const copy: Record<LangKey, {
  ...
  tr: { dir: 'ltr', flag: 'TR', voice: ['tr-TR'], greeting: 'Merhaba, nasıl yardımcı olabilirim?', question: 'En çok neye ihtiyacın var?', input: 'Mesajını yaz...', access: 'Hemen erişim al', price: 'Nihai ödeme EUR olarak alınır.', labels: { ai: 'AI araçları', design: 'Tasarım', productivity: 'Üretkenlik', unsure: 'Yardım et' }, intros: { ai: 'Harika seçim. Sana en uygun aracı seçmene yardımcı olabilirim.', design: 'Harika seçim. Tasarım için en uygun seçeneği gösterebilirim.', productivity: 'Günlük işlerini hızlandıracak pratik seçenekleri gösterebilirim.', unsure: 'Sana en uygun seçeneği seçmene yardımcı olabilirim.' } },
