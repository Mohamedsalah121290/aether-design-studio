...
const copy: Record<LangKey, {
  ...
  fr: { dir: 'ltr', flag: 'FR', voice: ['fr-FR', 'fr-BE'], greeting: 'Salut 👋 Voulez-vous que je trouve la meilleure offre pour vous ?', question: 'Choisissez ce qui vous aide le plus :', input: 'Écrivez votre message...', access: 'Obtenir l’accès', price: 'Le prix est affiché en EUR avant le paiement. Pensez gain de temps et accès utile.', labels: { ai: 'Meilleures offres', design: 'Comparer', productivity: 'Option moins chère', security: 'Accès sécurisé', unsure: 'Aidez-moi' }, intros: { ai: 'Les offres les plus choisies.', design: 'Voici des outils forts à comparer.', productivity: 'Options simples pour commencer aujourd’hui.', security: 'Les meilleurs choix pour rester protégé.', unsure: 'Commencez avec les outils les plus utiles.' } },
  nl: { dir: 'ltr', flag: 'NL', voice: ['nl-BE', 'nl-NL'], greeting: 'Hoi 👋 Zal ik de beste deal voor je vinden?', question: 'Kies wat je het meest helpt:', input: 'Typ je bericht...', access: 'Krijg toegang', price: 'De prijs staat in EUR vóór checkout. Denk aan tijdwinst en praktische toegang.', labels: { ai: 'Beste deals', design: 'Vergelijk tools', productivity: 'Goedkoopste optie', security: 'Veilige toegang', unsure: 'Help kiezen' }, intros: { ai: 'De meest gekozen deals.', design: 'Sterke tools om te vergelijken.', productivity: 'Snelle opties om vandaag te starten.', security: 'Beste keuzes voor veilige toegang.', unsure: 'Start met de meest nuttige tools.' } },
  de: { dir: 'ltr', flag: 'DE', voice: ['de-DE'], greeting: 'Hi 👋 Soll ich den besten Deal für dich finden?', question: 'Wähle, was dir am meisten hilft:', input: 'Nachricht eingeben...', access: 'Zugang erhalten', price: 'Der Preis wird vor dem Checkout in EUR angezeigt. Es geht um Zeitersparnis und praktischen Zugang.', labels: { ai: 'Beste Deals', design: 'Tools vergleichen', productivity: 'Günstigste Option', security: 'Sicherer Zugang', unsure: 'Hilf mir wählen' }, intros: { ai: 'Die meistgewählten Deals.', design: 'Starke Tools zum Vergleichen.', productivity: 'Einfache Optionen für heute.', security: 'Beste Optionen für sicheren Zugriff.', unsure: 'Starte mit den nützlichsten Tools.' } },
  es: { dir: 'ltr', flag: 'ES', voice: ['es-ES'], greeting: 'Hola 👋 ¿Quieres que encuentre la mejor oferta para ti?', question: 'Elige lo que más te ayuda:', input: 'Escribe tu mensaje...', access: 'Obtener acceso', price: 'El precio se muestra en EUR antes del pago. Piensa en ahorro de tiempo y acceso práctico.', labels: { ai: 'Mejores ofertas', design: 'Comparar tools', productivity: 'Opción barata', security: 'Acceso seguro', unsure: 'Ayúdame' }, intros: { ai: 'Las ofertas más elegidas.', design: 'Herramientas fuertes para comparar.', productivity: 'Opciones simples para empezar hoy.', security: 'Mejores opciones para acceso seguro.', unsure: 'Empieza con las herramientas más útiles.' } },
  it: { dir: 'ltr', flag: 'IT', voice: ['it-IT'], greeting: 'Ciao 👋 Vuoi che trovi l’offerta migliore per te?', question: 'Scegli cosa ti aiuta di più:', input: 'Scrivi il tuo messaggio...', access: 'Ottieni accesso', price: 'Il prezzo è mostrato in EUR prima del checkout. Conta il tempo risparmiato e l’accesso pratico.', labels: { ai: 'Migliori offerte', design: 'Confronta tool', productivity: 'Opzione economica', security: 'Accesso sicuro', unsure: 'Aiutami' }, intros: { ai: 'Le offerte più scelte.', design: 'Strumenti forti da confrontare.', productivity: 'Opzioni semplici per iniziare oggi.', security: 'Le migliori opzioni per accesso sicuro.', unsure: 'Inizia dagli strumenti più utili.' } },
  ar: { dir: 'rtl', flag: 'AR', voice: ['ar-SA', 'ar'], greeting: 'مرحباً 👋 هل تريد أن أجد لك أفضل عرض؟', question: 'اختر ما يناسبك:', input: 'اكتب رسالتك...', access: 'احصل على الوصول', price: 'السعر يظهر باليورو قبل الدفع. ركّز على الوقت الذي ستوفره والقيمة العملية.', labels: { ai: 'أفضل العروض', design: 'قارن الأدوات', productivity: 'الأرخص', security: 'وصول آمن', unsure: 'ساعدني أختار' }, intros: { ai: 'هذه أكثر العروض طلباً.', design: 'هذه أدوات قوية للمقارنة.', productivity: 'خيارات سهلة لتبدأ اليوم.', security: 'أفضل اختيارات للوصول الآمن.', unsure: 'ابدأ بالأدوات الأكثر فائدة.' } },
};
