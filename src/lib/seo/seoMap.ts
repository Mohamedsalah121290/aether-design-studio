...
export const SEO_MAP: Record<SeoPageKey, Record<SeoLang, SeoEntry>> = {
  ...
  dashboard: {
    en: { title: 'My Vault — Manage Your AI Subscriptions | AI DEALS', description: 'Your encrypted AI vault. Manage active tools, billing, access and renewals — all in one place. Members only.', h1: 'My AI Vault', primaryKeyword: 'AI subscriptions dashboard', secondaryKeywords: ['manage AI tools', 'AI vault', 'AI subscription manager'] },
    fr: { title: 'Mon Coffre — Gérez vos Abonnements IA | AI DEALS', description: 'Votre coffre IA chiffré. Gérez outils actifs, facturation, accès et renouvellements — tout au même endroit. Réservé aux membres.', h1: 'Mon Coffre IA', primaryKeyword: 'tableau de bord abonnements IA', secondaryKeywords: ['gérer outils IA', 'coffre IA', 'gestionnaire abonnement IA'] },
    nl: { title: 'Mijn Kluis — Beheer je AI-abonnementen | AI DEALS', description: 'Jouw versleutelde AI-kluis. Beheer actieve tools, facturatie, toegang en verlengingen — alles op één plek. Alleen voor leden.', h1: 'Mijn AI-Kluis', primaryKeyword: 'AI abonnementen dashboard', secondaryKeywords: ['AI tools beheren', 'AI kluis', 'AI abonnement manager'] },
    de: { title: 'Mein Tresor — KI-Abos verwalten | AI DEALS', description: 'Ihr verschlüsselter KI-Tresor. Verwalten Sie aktive Tools, Abrechnung, Zugänge und Verlängerungen — alles an einem Ort.', h1: 'Mein KI-Tresor', primaryKeyword: 'KI Abos Dashboard', secondaryKeywords: ['KI-Tools verwalten', 'KI Tresor', 'KI-Abo Manager'] },
    es: { title: 'Mi Bóveda — Gestiona tus Suscripciones IA | AI DEALS', description: 'Tu bóveda IA cifrada. Gestiona herramientas activas, facturación, acceso y renovaciones — todo en un solo lugar. Solo miembros.', h1: 'Mi Bóveda IA', primaryKeyword: 'panel suscripciones IA', secondaryKeywords: ['gestionar herramientas IA', 'bóveda IA', 'gestor suscripción IA'] },
    pt: { title: 'O Meu Cofre — Gerir Subscrições IA | AI DEALS', description: 'O seu cofre IA encriptado. Gira ferramentas ativas, faturação, acesso e renovações — tudo num só lugar. Apenas para membros.', h1: 'O Meu Cofre IA', primaryKeyword: 'painel subscrições IA', secondaryKeywords: ['gerir ferramentas IA', 'cofre IA', 'gestor subscrição IA'] },
    ar: { title: 'خزنتي — إدارة اشتراكات الذكاء الاصطناعي | AI DEALS', description: 'خزنتك المشفرة للذكاء الاصطناعي. أدِر الأدوات النشطة والفوترة والوصول والتجديدات في مكان واحد. للأعضاء فقط.', h1: 'خزنتي للذكاء الاصطناعي', primaryKeyword: 'لوحة اشتراكات الذكاء الاصطناعي', secondaryKeywords: ['إدارة أدوات الذكاء الاصطناعي', 'خزنة الذكاء الاصطناعي', 'مدير اشتراكات الذكاء الاصطناعي'] },
  },
