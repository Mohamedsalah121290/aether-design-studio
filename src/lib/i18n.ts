...
const resources = {
  ...
  hi: {
    translation: {
      ...
      dashboard: { vaultTitle: 'मेरी वॉल्ट', vaultSubtitle: 'आपके खरीदे गए AI टूल्स', allToolsActive: 'सभी टूल्स सक्रिय', secureAccess: 'सुरक्षित पहुंच', toolsOwned: 'स्वामित्व वाले टूल्स', searchTools: 'अपने टूल्स खोजें...', launchTool: 'टूल लॉन्च करें', purchasedOn: 'खरीदा', noToolsFound: 'कोई टूल नहीं मिला', browseStore: 'AI टूल्स खरीदने के लिए स्टोर ब्राउज़ करें', goToStore: 'स्टोर पर जाएं', active: 'सक्रिय', member: 'सदस्य' },
  ...
  bn: {
    translation: {
      ...
      dashboard: { vaultTitle: 'আমার ভল্ট', vaultSubtitle: 'আপনার কেনা AI টুলস', allToolsActive: 'সব টুলস সক্রিয়', secureAccess: 'নিরাপদ অ্যাক্সেস', toolsOwned: 'মালিকানাধীন টুলস', searchTools: 'আপনার টুলস খুঁজুন...', launchTool: 'টুল লঞ্চ করুন', purchasedOn: 'ক্রয়ের তারিখ', noToolsFound: 'কোন টুল পাওয়া যায়নি', browseStore: 'AI টুলস কিনতে স্টোর ব্রাউজ করুন', goToStore: 'স্টোরে যান', active: 'সক্রিয়', member: 'সদস্য' },
  ...
  ur: {
    translation: {
      ...
      dashboard: { vaultTitle: 'میری والٹ', vaultSubtitle: 'آپ کے خریدے ہوئے AI ٹولز', allToolsActive: 'تمام ٹولز فعال ہیں', secureAccess: 'محفوظ رسائی', toolsOwned: 'ملکیتی ٹولز', searchTools: 'اپنے ٹولز تلاش کریں...', launchTool: 'ٹول لانچ کریں', purchasedOn: 'خریداری کی تاریخ', noToolsFound: 'کوئی ٹول نہیں ملا', browseStore: 'AI ٹولز خریدنے کے لیے اسٹور دیکھیں', goToStore: 'اسٹور پر جائیں', active: 'فعال', member: 'رکن' },
